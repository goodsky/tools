...
public class Vines implements ILSystem {
	// The LSystem
				...
				if (cur == params.lenAlphabet[k])
				{
					...
					else if (diff < 0)
					{
						if (rand <= 10)
							...
							newplant.append("ba-[-b+a]+[+a-a-a]-a");
					}
					// turn right
					else
					{
						if (rand <= 10)
							...
							newplant.append("ba+[+b-a]-[-b+a]a");
						else if (rand <= 90)
							newplant.append("ba+[+b-a]-[-b+a+a]+a");
						else
							newplant.append("ba-[-b+a]+[+b-a-a]");
					}
